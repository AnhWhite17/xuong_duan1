...
<head>
    ...
    <title>Măm Măm - Multipurpose eCommerce HTML Template</title>

    <!-- App favicon -->
    <link rel="shortcut icon" href="asset/Admin/images/logo/logoMamMam.png">

    <!-- Icon CSS -->
    <link rel="stylesheet" href="asset/Userscss/vendor/materialdesignicons.min.css">
    <link rel="stylesheet" href="asset/Userscss/vendor/remixicon.css">

    <!-- Vendor -->
    <link rel="stylesheet" href="asset/Userscss/vendor/animate.css">
    <link rel="stylesheet" href="asset/Userscss/vendor/bootstrap.min.css">
    <link rel="stylesheet" href="asset/Userscss/vendor/aos.min.css">
    <link rel="stylesheet" href="asset/Userscss/vendor/range-slider.css">
    <link rel="stylesheet" href="asset/Userscss/vendor/swiper-bundle.min.css">
    <link rel="stylesheet" href="asset/Userscss/vendor/jquery.slick.css">
    <link rel="stylesheet" href="asset/Userscss/vendor/slick-theme.css">

    <!-- Main CSS -->
    <link rel="stylesheet" href="asset/Userscss/style.css">
</head>
...
<body class="body-bg-6">
                ...
                <div class="col-lg-12">
                    <div class="top-header">
                        <a href="index.html" class="cr-logo">
                            <img src="asset/Usersimg/logo/logo.png" alt="logo" class="logo">
                            <img src="asset/Usersimg/logo/dark-logo.png" alt="logo" class="dark-logo">
                        </a>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="cr-register" data-aos="fade-up" data-aos-duration="2000" data-aos-delay="400">
                        <div class="form-logo">
                            <img src="asset/Usersimg/logo/logo.png" alt="logo">
                        </div>
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <a href="#" class="cr-payment-image">
                                            <img src="asset/Usersimg/insta/1.jpg" alt="insta">
                                            <div class="payment-overlay"></div>
                                        </a>
                                    </div>
                                    <div class="swiper-slide">
                                        <a href="#" class="cr-payment-image">
                                            <img src="asset/Usersimg/insta/2.jpg" alt="insta">
                                            <div class="payment-overlay"></div>
                                        </a>
                                    </div>
                                    <div class="swiper-slide">
                                        <a href="#" class="cr-payment-image">
                                            <img src="asset/Usersimg/insta/3.jpg" alt="insta">
                                            <div class="payment-overlay"></div>
                                        </a>
                                    </div>
                                    <div class="swiper-slide">
                                        <a href="#" class="cr-payment-image">
                                            <img src="asset/Usersimg/insta/4.jpg" alt="insta">
                                            <div class="payment-overlay"></div>
                                        </a>
                                    </div>
                                    <div class="swiper-slide">
                                        <a href="#" class="cr-payment-image">
                                            <img src="asset/Usersimg/insta/5.jpg" alt="insta">
                                            <div class="payment-overlay"></div>
                                        </a>
                                    </div>
                                    <div class="swiper-slide">
                                        <a href="#" class="cr-payment-image">
                                            <img src="asset/Usersimg/insta/6.jpg" alt="insta">
                                            <div class="payment-overlay"></div>
                                        </a>
                                    </div>
                                    <div class="swiper-slide">
                                        <a href="#" class="cr-payment-image">
                                            <img src="asset/Usersimg/insta/7.jpg" alt="insta">
                                            <div class="payment-overlay"></div>
                                        </a>
                                    </div>
                                    <div class="swiper-slide">
                                        <a href="#" class="cr-payment-image">
                                            <img src="asset/Usersimg/insta/8.jpg" alt="insta">
                                            <div class="payment-overlay"></div>
                                        </a>
                                    </div>
                                </div>
        ...
        <div class="cr-cart-inner">
            <div class="cr-cart-top">
                ...
                <ul class="crcart-pro-items">
                    <li>
                        <a href="product-left-sidebar.html" class="crside_pro_img"><img src="asset/Usersimg/product/4.jpg"
                                alt="product-1"></a>
                    ...
                    <li>
                        <a href="product-left-sidebar.html" class="crside_pro_img"><img src="asset/Usersimg/product/2.jpg"
                                alt="product-2"></a>
                        <div class="cr-pro-content">
                    ...
                    <li>
                        <a href="product-left-sidebar.html" class="crside_pro_img"><img src="asset/Usersimg/product/3.jpg"
                                alt="product-3"></a>
                        <div class="cr-pro-content">
        ...
        <div class="cr-tool-btn">
            ...
            <div class="color-variant">
                ...
                <div class="cr-tools-detail">
                    ...
                    <ul class="rtl-mode">
                        <li class="rtl">
                            <img src="asset/Usersimg/tool/rtl.png" alt="rtl">
                        </li>
                        <li class="ltr active-rtl-mode">
                            <img src="asset/Usersimg/tool/ltr.png" alt="ltr">
                        </li>
                    </ul>
                </div>
                <div class="cr-tools-detail">
                    ...
                    <ul class="bg-panel">
                        <li class="bg-1">
                            <img src="asset/Usersimg/shape/bg-shape-1.png" alt="bg-shape-1">
                        </li>
                        <li class="bg-2">
                            <img src="asset/Usersimg/shape/bg-shape-2.png" alt="bg-shape-2">
                        </li>
                        <li class="bg-3">
                            <img src="asset/Usersimg/shape/bg-shape-3.png" alt="bg-shape-3">
                        </li>
                        <li class="bg-4">
                            <img src="asset/Usersimg/shape/bg-shape-4.png" alt="bg-shape-4">
                        </li>
                        <li class="bg-5">
                            <img src="asset/Usersimg/shape/bg-shape-5.png" alt="bg-shape-5">
                        </li>
                        <li class="bg-6 active-bg-panel">
                            <img src="asset/Usersimg/shape/bg-shape-6.png" alt="bg-shape-6">
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <!-- Vendor Custom -->
    <script src="asset/Usersjs/vendor/jquery-3.6.4.min.js"></script>
    <script src="asset/Usersjs/vendor/jquery.zoom.min.js"></script>
    <script src="asset/Usersjs/vendor/bootstrap.bundle.min.js"></script>
    <script src="asset/Usersjs/vendor/mixitup.min.js"></script>
    <script src="asset/Usersjs/vendor/range-slider.js"></script>
    <script src="asset/Usersjs/vendor/aos.min.js"></script>
    <script src="asset/Usersjs/vendor/swiper-bundle.min.js"></script>
    <script src="asset/Usersjs/vendor/slick.min.js"></script>

    <!-- Main Custom -->
    <script src="asset/Usersjs/main.js"></script>
</body>
