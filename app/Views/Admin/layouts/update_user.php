                    ...
                    <div class="main-content">
                        ...
                        <div class="main-content-inner">
                            ...
                            <div class="wg-box">
                                    ...
                                    <form action="<?php BASE_URL ?>?role=admin&act=update_post_user&id_user=<?= $_GET['id_user'] ?>" method="post" enctype="multipart/form-data">
                                        <div class="mb-5">
                                            <label for="user">Name</label>
                                            <input type="text" id="user" placeholder="user" name="user" class="form-control" value="<?= $user->user ?>">
                                        </div>
                                        <div class="mb-5">
                                            <label for="email">Email</label>
                                            <input type="text" id="email" placeholder="email" name="email" class="form-control" value="<?= $user->email ?>">
                                        </div>
                                        <div class="mb-5">
                                            <label for="pass">Password</label>
                                            <input type="text" id="pass" placeholder="pass" name="pass" class="form-control" value="<?= $user->pass ?>">
                                        </div>
                                        <div class="mb-5">
                                        ...
                                        <div class="mb-5">
                                            ...
                                            <img src="<?= $user->img ?>" width="70px">
                                            <input type="file" id="img" placeholder="img" name="img" accept="img/*" class="form-control" >
                                        </div>
                                        <div class="mb-5">
                                            <label for="tel">Phone</label>
                                            <input type="text" id="tel" placeholder="tel" name="tel" class="form-control" value="<?= $user->tel ?>">
                                        </div>
                                        <div class="mb-5">
