                        ...
                        <div class="main-content-inner">
                            ...
                            ?>>
                                    ...
                                    <div class="flex items-center justify-between gap10 flex-wrap">
                                        ...
                                        <a class="tf-button style-1 w208" href="<?php BASE_URL ?>?role=admin&act=add_user"><i class="icon-plus"></i>Add new</a>
                                    </div>
                                    <div class="wg-table table-product-list">
                                        ...
                                        <ul class="flex flex-column">
                                            ...
                                            <div class="body-text text-main-dark mt-4"><?= $value -> user ?></div>
                                            <div class="body-text text-main-dark mt-4"><?= $value -> email ?></div>
                                            <div class="body-text text-main-dark mt-4"><img src="<?= $value -> img ?>" width="70px" ></div>
                                                <div class="list-icon-function">
                                                    <div class="item eye">
                                                        <i class="icon-eye"></i>
                                                    </div>
                                                    <div class="item edit">
                                                        <a href="<?php BASE_URL ?>?role=admin&act=update_user&id_user=<?= $value->id_user ?>">
                                                        <i class="icon-edit-3"></i>
                                                        </a>
                                                    </div>
                                                    <div class="item trash">
                                                        <a href="<?php BASE_URL ?>?role=admin&act=delete_user&id_user=<?= $value->id_user ?>  ">
