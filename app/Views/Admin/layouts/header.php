<div class="header-dashboard">
                        <div class="wrap">
                            <div class="header-left">
                                <a href="index.html">
                                    <img class="" id="logo_header_mobile" alt="" src="asset/Admin/images/logo/logoMamMam.png">
                                </a>
                                                ...
                                                <ul>
                                                    <li class="product-item gap14 mb-10">
                                                        <div class="image no-bg">
                                                            <img src="asset/Admin/images/products/product-1.jpg" alt="">
                                                        </div>
                                                    ...
                                                    <li class="product-item gap14 mb-10">
                                                        <div class="image no-bg">
                                                            <img src="asset/Admin/images/products/product-2.jpg" alt="">
                                                        </div>
                                                        <div class="flex items-center justify-between gap20 flex-grow">
                                                            <div class="name">
                                                    ...
                                                    <li class="product-item gap14">
                                                        <div class="image no-bg">
                                                            <img src="asset/Admin/images/products/product-3.jpg" alt="">
                                                        </div>
                                                        <div class="flex items-center justify-between gap20 flex-grow">
                                                            <div class="name">
                                        ...
                                        <ul class="">
                                            ...
                                            <li>
                                                <ul>
                                                    <li class="product-item gap14 mb-10">
                                                        <div class="image no-bg">
                                                            <img src="asset/Admin/images/products/product-4.jpg" alt="">
                                                        </div>
                                                        <div class="flex items-center justify-between gap20 flex-grow">
                                                            <div class="name">
                                                    ...
                                                    <li class="product-item gap14 mb-10">
                                                        <div class="image no-bg">
                                                            <img src="asset/Admin/images/products/product-5.jpg" alt="">
                                                        </div>
                                                        <div class="flex items-center justify-between gap20 flex-grow">
                                                            <div class="name">
                                                    ...
                                                    <li class="product-item gap14 mb-10">
                                                        <div class="image no-bg">
                                                            <img src="asset/Admin/images/products/product-6.jpg" alt="">
                                                        </div>
                                                        <div class="flex items-center justify-between gap20 flex-grow">
                                                            <div class="name">
                                                    ...
                                                    <li class="product-item gap14">
                                                        <div class="image no-bg">
                                                            <img src="asset/Admin/images/products/product-7.jpg" alt="">
                                                        </div>
                                                        <div class="flex items-center justify-between gap20 flex-grow">
                                                            <div class="name">
                                                                <a href="product-list.html" class="body-text">Jersey thong body</a>
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end has-content" aria-labelledby="dropdownMenuButton1" >
                                            ...
                                            <li>
                                                <div class="noti-item w-full wg-user active">
                                                    <div class="image">
                                                        <img src="asset/Admin/images/customers/customer-1.jpg" alt="">
                                                    </div>
                                                    <div class="flex-grow">
                                            ...
                                            <li>
                                                <div class="noti-item w-full wg-user active">
                                                    <div class="image">
                                                        <img src="asset/Admin/images/customers/customer-2.jpg" alt="">
                                                    </div>
                                                    <div class="flex-grow">
                                                        <div class="flex items-center justify-between">
                                            ...
                                            <li>
                                                <div class="noti-item w-full wg-user active">
                                                    <div class="image">
                                                        <img src="asset/Admin/images/customers/customer-3.jpg" alt="">
                                                    </div>
                                                    <div class="flex-grow">
                                                        <div class="flex items-center justify-between">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end has-content" aria-labelledby="dropdownMenuButton4" >
                                            ...
                                            <li>
                                                <ul class="list-apps">
                                                    ...
                                                    <li class="item">
                                                        <div class="image">
                                                            <img src="asset/Admin/images/apps/item-4.png" alt="">
                                                        </div>
                                                        <a href="#">
                                ...
                                <div class="popup-wrap user type-header">
                                    <div class="dropdown">
                                        <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton3" data-bs-toggle="dropdown" aria-expanded="false">
                                            <span class="header-user wg-user">
                                                ...
                                                <span class="flex flex-column">
                                                    <span class="body-text text-main-dark"><?= $_SESSION['users']['user'] ?></span>
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end has-content" aria-labelledby="dropdownMenuButton3" >
                                            <li>
                                                <a href="<?= BASE_URL ?>" class="user-item">
                                                    <div class="icon">
                                                        <i class="icon-home"></i>
                                                    </div>
                                                    <div class="body-title-2">Exit to User</div>
                                                </a>
                                            </li>
                                            <li>
