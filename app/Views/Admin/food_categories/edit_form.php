                        ...
                        <div class="main-content-inner">
                            ...
                            <div class="main-content-wrap">
                                <div class="wg-box">
                                    ...
                                    <?php endif; ?>
                                    <form method="POST" action="?role=admin&act=update">
                                        <input type="hidden" name="id_catalog" value="<?= htmlspecialchars($category['id_catalog']) ?>" />
                                        <div class="form-group">
                                            <label for="name_catalog">Name Category:</label>
                                            <input type="text" name="name_catalog" id="name_catalog" class="form-control"
                                                value="<?= htmlspecialchars($category['name_catalog']) ?>" required />
                                        </div>
                                        <button type="submit" class="btn btn-primary">Update</button>
                                        <a href="?role=admin&act=danhmuc" class="btn btn-secondary">Exit</a>
                                    </form>
                                </div>
                            </div>
