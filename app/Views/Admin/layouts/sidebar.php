<div class="section-menu-left">
                    <div class="box-logo">
                        <a href="index.html" id="site-logo-inner">
                            <img class="" id="logo_header" alt="" src="asset/Admin/images/logo/logoMamMam.png" style="width: 70px;">
                        </a>
                                ...
                                <ul class="">
                                    ...
                                    ">
                                        <a href="<?= BASE_URL ?>?role=admin&act=home" class="">
                                            ...
                                            <div class="text">dasboat</div>
                                        </a>
                                    </li>
                                    <li class="menu-item has-children
                                        <?php if(isset($_GET['act']) && ($_GET['act'] == 'product' || $_GET['act'] == 'form-create-product' || $_GET['act'] == 'create-product' || $_GET['act'] == 'update-product')) {echo 'active';} ?>
                                    ">
                                        ...
                                        <ul class="sub-menu">
                                            <li class="sub-menu-item">
                                                <a href="<?php BASE_URL ?>?role=admin&act=product" class="">
                                                    <div class="text">All Products</div>
                                                </a>
                                            </li>
                                            <li class="sub-menu-item">
                                                <a href="<?php BASE_URL ?>?role=admin&act=form-create-product" class="">
                                    ...
                                    <li class="menu-item has-children">
                                        ...
                                        <ul class="sub-menu">
                                            <li class="sub-menu-item">
                                                <a href="<?php BASE_URL ?>?role=admin&act=danhmuc" class="">
                                                    <div class="text">Category list</div>
                                                </a>
                                            </li>
                                            <li class="sub-menu-item">
                                                <a href="<?php BASE_URL ?>?role=admin&act=createForm" class="">
                                    ...
                                    <li class="menu-item has-children 
                                     <?php if(isset($_GET['act']) && ($_GET['act']) == 'all_user'){echo 'active';} ?>
                                    ">
                                        <a href="javascript:void(0);" class="menu-item-button">
                                        ...
                                        <ul class="sub-menu">
                                            <li class="sub-menu-item">
                                                <a href="<?= BASE_URL ?>?role=admin&act=all_user" class="">
                                                    <div class="text">All user</div>
                                                </a>
                                            </li>
                                            <li class="sub-menu-item">
                                                <a href="<?= BASE_URL ?>?role=admin&act=add_user" class="">
