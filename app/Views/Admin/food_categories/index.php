                            ...
                            <div class="main-content-wrap">
                                <div class="wg-box">
                                    ...
                                    <div class="flex items-center justify-between gap10 flex-wrap">
                                        ...
                                        <a class="tf-button style-1 w208" href="<?php BASE_URL ?>?role=admin&act=createForm"><i class="icon-plus"></i>Add new</a>
                                    </div>
                                        ...
                                        <ul class="flex flex-column">
                                            ...
                                            foreach ($categories as $category => $value): ?>
                                                <li class="wg-product item-row gap20">
                                                    <div class="body-text text-main-dark mt-4"><?= $category + 1 ?></div>
                                                    <div class="body-text text-main-dark mt-4"><?= $value->id_catalog ?></div>
                                                    <div class="body-text text-main-dark mt-4"><?= $value->name_catalog ?></div>
                                                    <div class="list-icon-function">
                                                        <div class="item eye">
                                                            <i class="icon-eye"></i>
                                                        </div>
                                                        <div class="item edit">
                                                            <a href="<?php echo BASE_URL ?>?role=admin&act=editForm&id_catalog=<?= $value->id_catalog ?>" class="item edit">
                                                                <i class="icon-edit-3"></i>
                                                            </a>
                                                        </div>
                                                        <div class="item trash">
                                                            <a href="<?php echo BASE_URL; ?>?role=admin&act=delete&id_catalog=<?= $value->id_catalog ?>"
                                                                onclick="return confirm('Bạn chắc chắn muốn xóa danh mục <?= $value->name_catalog ?>?');">
