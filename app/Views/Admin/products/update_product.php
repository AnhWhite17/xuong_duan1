                        ...
                        <div class="main-content-inner">
                            ...
                            <div class="main-content-wrap">
                                <div class="wg-box">
                                    ...
                                    <form method="post" action="<?php BASE_URL ?>?role=admin&act=update-post-product&id=<?= $_GET['id'] ?>" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="describe" id="describe" class="form-control" rows="4" value="<?= $product->describe ?>"></textarea>
                                        </div>
                                        <div class="form-group">
